...
const DEF_VALUE: InstallValue = {
    title: "Install",
    body: "Add the page builder and a JsonForm theme for the edit dialogs.",
    command:
        "npm i -S @undermuz/react-page-builder @undermuz/react-json-form-theme-base",
    themeNote:
        "Wrap BlocksEditor with UiContext.Provider and import the theme CSS. BlocksView does not need the form theme.",
}
