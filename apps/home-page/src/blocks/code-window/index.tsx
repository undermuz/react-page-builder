...
const DEF_VALUE: CodeWindowValue = {
    title: "Page value is just JSON",
    body: "Each instance stores id, blockId, and value. Persist that array — reload with BlocksView anywhere.",
    filename: "page.value.ts",
    code: `export default [
  {
    id: 101,
    blockId: "hero",
    value: {
      ...
      headline: "Compose UI from JSON blocks"
    }
  },
  {
    id: 102,
    blockId: "install",
    value: {
      command: "npm i -S @undermuz/react-page-builder"
    }
  }
]`,
}
...
const CodeWindowBlock: IBlock<CodeWindowValue> = {
    id: "code-window",
    title: "Code window",
    description: "Visual code / JSON sample",
    image: "",
    value: DEF_VALUE,
    scheme,
    view: CodeWindowView,
